...
<div class="bm-faq">
<details class="bm-faq-item" name="bm-faq" open><summary class="bm-faq-q"><span>🧷 Will this fit my keyboard?</span><span class="bm-plus"></span></summary><div class="bm-faq-a"><p>It fits any keyboard using standard MX-style cross-stem switches — 60%, 65%, 75%, TKL, 96%, and full-size. Not sure? Just send us a link or photo of your keyboard and we'll confirm it fits — we'll handle the rest.</p></div></details>
<details class="bm-faq-item" name="bm-faq"><summary class="bm-faq-q"><span>📦 Is a keyboard included?</span><span class="bm-plus"></span></summary><div class="bm-faq-a"><p>No — this listing is for the keycap set only. Any keyboard, switches, or other props shown in the photos are for display purposes and are not included.</p></div></details>
...
<div class="bm-note"><b>📦 In the box:</b> keycap set, keycap puller, thank-you card with a surprise coupon.<br><b>💬 Compatibility questions?</b> Please contact us before you order and we'll check your keyboard.</div>
...
<section class="pd-ck__section">
<div class="pd-ck__box"><b>📦 In the box:</b> keycap set, keycap puller, thank-you card with a surprise coupon.<br><b>💬 Compatibility questions?</b> Please contact us before you order and we'll check your keyboard.</div>
</section>
